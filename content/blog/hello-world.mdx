...
Currently specializing in TypeScript-first architectures with **Angular/Next.js/NestJS/Convex** and exploring Web3/blockchain technologies and AI integrations.
...
**4. Staying current forces learning.** The space is moving so fast right now. especially AI. writing about tech means i have to stay up to date with the latest developments. exploring and experimenting with new stuff, which i do anyway. writing it up is just one step further.
