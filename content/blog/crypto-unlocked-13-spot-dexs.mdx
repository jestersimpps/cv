...
|------|-------------|----------|----------|
| **AMM** | Liquidity pools + constant product formula | General token swaps | Uniswap, Raydium, Orca |
| **Stableswap** | Optimized curve for same-peg assets | Stablecoin & LST swaps | Curve, Balancer |
| **ve(3,3)** | Vote-escrowed tokens direct emissions to pools | Community-governed liquidity | Velodrome, Aerodrome |
| **Aggregator** | Routes across multiple DEXs for best price | Large swaps, MEV protection | 1inch, CowSwap, Jupiter |
| **Order Book** | On-chain limit orders matched by engine | Precision trading | dYdX, Hyperliquid |
