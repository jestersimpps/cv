...
- **ConstitutionDAO** — In 2021, thousands of strangers on the internet pooled $47 million to try to buy an original copy of the U.S. Constitution at a Sotheby's auction. They lost the bid, but proved that internet strangers could coordinate capital at scale in days.
...
3. **Token holders vote** — One token usually equals one vote. Voting happens on-chain or through snapshot voting (off-chain but verifiable)
...
**ENS (Ethereum Name Service)** lets you register a human-readable name like `yourname.eth`. It works like a domain name for your wallet — and for your identity. You can attach your website, social profiles, email, and more to a single ENS name that **you** own. No company can take it away.
...
- Any developer can build a client (app) on top of the protocol
- If you don't like one app, switch to another — your followers come with you

**Lens Protocol** takes a similar approach, turning your social profile into an NFT you own. Your followers, posts, and interactions are all on-chain assets under your control.
...
- **IPFS (InterPlanetary File System)** — A peer-to-peer network where files are addressed by their content hash, not their location. Instead of "this file lives at amazon.com/server5/image.jpg," it's "this file has fingerprint QmX7b3...". Anyone hosting a copy can serve it.
- **Arweave** — Permanent storage. You pay once, and your data is stored forever (in theory) across a decentralized network. Think of it as the Internet Archive, but trustless.
...
We've covered the theory — blockchains, DeFi, NFTs, and now Web3. But what does all this look like in practice? In **Part 17**, we'll explore **real-world applications** — the places where crypto is already making a tangible difference outside of trading and speculation. Supply chains, remittances, digital identity in developing nations, and more. The rubber meets the road.
