...
> **What is Beads?** [Beads](https://github.com/subsy/beads) is a lightweight CLI issue tracker designed for AI-driven workflows. It stores issues as local markdown files with dependency tracking, making it easy for Claude to read and update task status. The "Smart Mode" option adds [Beads Viewer](https://github.com/subsy/beads-viewer) which visualizes task dependencies and uses PageRank to suggest which task to tackle next based on blockers and critical path analysis.
