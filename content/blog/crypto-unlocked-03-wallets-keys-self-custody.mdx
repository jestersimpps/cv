...
graph TD
    ...
    style CU fill:#dc2626,stroke:#991b1b,color:#fff
    style NC fill:#059669,stroke:#047857,color:#fff
    style HO fill:#f59e0b,stroke:#d97706,color:#000
    style CO fill:#1e40af,stroke:#1e3a8a,color:#fff
    style EX fill:#dc2626,stroke:#991b1b,color:#fff
```
