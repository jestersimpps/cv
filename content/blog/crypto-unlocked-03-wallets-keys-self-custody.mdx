...
In November 2022, over a million people woke up to find their crypto gone. Not hacked. Not stolen by some shadowy figure in a hoodie. Just... *gone*. The exchange they trusted — FTX, run by the curly-haired golden boy of crypto — had been gambling with their money behind the scenes. Billions of dollars, evaporated overnight.
...
You don't actually "store" crypto in a wallet the way you store cash in a physical wallet. Your crypto lives on the blockchain (that shared ledger we talked about in Part 1). Your private key is just the proof that you're allowed to move it. The wallet is really just software that manages your keys for you.
...
**Popular hot wallets:**
- **MetaMask** — The OG browser wallet. Works with Ethereum and most EVM-compatible chains. Browser extension + mobile app.
- **Rabby** — A newer, slicker alternative to MetaMask with better security warnings and multi-chain support. My personal daily driver.
- **Phantom** — Started on Solana, now supports Ethereum and Bitcoin too. Clean interface, great mobile app.
...
- **Ledger** (Nano S Plus, Nano X, Stax) — The market leader. Sleek hardware, solid app ecosystem. Had a controversial data breach of customer *shipping addresses* (not keys) in 2020, and a firmware controversy in 2023, but the actual key security has held up.
- **Trezor** (Model One, Model T, Safe 3) — Open-source firmware, which the security community loves. Strong track record.
...
Here's the deal. When you buy crypto on an exchange like Coinbase, Binance, or Kraken, you don't actually hold that crypto. The exchange does. They have the private keys. You have an IOU — a balance on their platform that says "we owe you 0.5 BTC."
...
FTX was the second-largest crypto exchange in the world. Celebrity endorsements. Super Bowl ads. Sam Bankman-Fried was on magazine covers, advising Congress, being called the "next Warren Buffett."

Behind the scenes, FTX was using customer deposits — billions of dollars — to prop up risky bets at their sister trading firm, Alameda Research. When the market turned, there was a bank run, and the money simply wasn't there.

**Result:** Over $8 billion in customer funds, gone. People who had their life savings on FTX couldn't withdraw a single dollar. The bankruptcy process dragged on for years.
...
| | **Custodial** (Exchange) | **Non-Custodial** (Your Wallet) |
|---|---|---|
| Who holds the keys? | The exchange | You |
| Can you be frozen out? | Yes | No |
| Recovery if you lose access? | Customer support | Seed phrase only |
| Risk | Exchange hack, fraud, bankruptcy | Losing your seed phrase, personal security |
| Example | Coinbase, Binance, Kraken | MetaMask, Ledger, Phantom |
...
1. **Download a hot wallet** — I'd recommend [Rabby](https://rabby.io) or [MetaMask](https://metamask.io). Go directly to the official website. Don't Google it and click an ad.
...
5. **Optional but recommended** — Once you have meaningful amounts, invest in a Ledger or Trezor and move your long-term holdings there.
...
In **Part 4**, we're going to blow the doors open. We'll dive into **Ethereum and Smart Contracts** — where crypto stops being just digital cash and becomes a programmable platform that can run code, enforce agreements, and power entirely new kinds of applications. This is where things get really interesting.
