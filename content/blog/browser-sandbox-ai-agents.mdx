...
the browser is probably the most battle-tested sandbox on the planet. billions of users click on random links every day and their computers don't explode. that's not an accident—it's the result of decades of security work by browser vendors.
