...
graph TD
    ...
    style ETH fill:#7c3aed,stroke:#5b21b6,color:#fff
    style ARB fill:#1e40af,stroke:#1e3a8a,color:#fff
    style OP fill:#dc2626,stroke:#991b1b,color:#fff
    style BASE fill:#1e40af,stroke:#1e3a8a,color:#fff
    style ZKS fill:#059669,stroke:#047857,color:#fff
    style STARK fill:#059669,stroke:#047857,color:#fff
    style SOL fill:#9333ea,stroke:#7e22ce,color:#fff
    style AVAX fill:#dc2626,stroke:#991b1b,color:#fff
    style COSMOS fill:#1e40af,stroke:#1e3a8a,color:#fff
```
