...
- **Jupiter** — The go-to swap aggregator. Think of it as Solana's Google for finding the best token prices. It routes your trade across multiple exchanges to get you the best deal. Jupiter has become *the* DeFi hub on Solana.
...
In 2023, Solana did something no other blockchain had seriously attempted: they shipped a phone. The **Saga** was an Android device with a built-in crypto wallet, a seed vault for secure key storage, and a dApp store.
...
**The outages.** Between 2022 and early 2023, Solana experienced multiple network outages — full stops where the chain just... didn't work. Some lasted hours. For a chain marketing itself as the future of high-speed finance, going offline is about the worst look possible. The causes varied (bot spam, consensus bugs, validator issues), but the pattern was concerning.

**The FTX connection.** Sam Bankman-Fried's FTX and Alameda Research were massive Solana backers. They held billions in SOL. When FTX collapsed in November 2022, it dragged SOL's price from ~$35 down to under $10. The entire ecosystem was painted with the FTX brush. Many wrote Solana's obituary.
...
No honest Solana article can skip this. In 2024, Solana became ground zero for the memecoin explosion, largely thanks to **pump.fun** — a platform that let anyone launch a token in seconds with minimal cost.
