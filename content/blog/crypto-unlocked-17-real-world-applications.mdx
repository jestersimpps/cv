...
graph LR
    ...
    style RA fill:#f59e0b,stroke:#d97706,color:#000
    style SPV fill:#1e40af,stroke:#1e3a8a,color:#fff
    style SC fill:#7c3aed,stroke:#5b21b6,color:#fff
    style TK fill:#059669,stroke:#047857,color:#fff
    style DEX fill:#059669,stroke:#047857,color:#fff
    style INV fill:#f59e0b,stroke:#d97706,color:#000
```
