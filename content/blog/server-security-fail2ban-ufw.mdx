...
Here's what my server reported after just a few hours — 9 banned IPs from 7 countries:
...
Same botnets hitting from multiple IPs — 3× Byteplus (Singapore/HK), 3× Unmanaged LTD (NL/US).
