---
title: "Crypto Unlocked Part 11: Advanced DeFi"
...
```mermaid
graph TD
    A[💰 Deposit Tokens] -->|provide to pool/vault| B[🏦 Protocol]
    B -->|earns| C[📈 Yield + Reward Tokens]
    C -->|sell rewards| D[💵 Take Profit]
    D -->|reinvest| A
    B -->|natural yield| E[✅ Interest / Fees]
    C -->|compound| A
...
![Liquid staking flow — stake ETH, receive stETH, use across DeFi](/assets/blog/crypto-unlocked-11/liquid-staking-flow.png)
...
![The Curve Wars — protocols battling for control of CRV emissions](/assets/blog/crypto-unlocked-11/curve-wars-battle.png)
