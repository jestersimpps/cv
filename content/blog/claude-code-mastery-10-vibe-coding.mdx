...
description: "The mindset that separates people who use AI from people who flow with it. Learn the philosophy behind truly effective AI-assisted development."
...
You've learned:
- Part 1: Setup and first commands
- Part 2: How Claude Code thinks
- Part 3: Project configuration with CLAUDE.md
- Part 4: Custom commands for workflow
- Part 5: Skills for specialized tasks
- Part 6: Subagents for parallel work
- Part 7: MCP servers for external integration
- Part 8: Production workflows and GitHub
- Part 9: Power user secrets and hidden features
- Part 10: The vibe coding philosophy
