...
![The bankruptcy of Lehman Brothers in September 2008 became a symbol of the global financial crisis](https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Lehman_Brothers_Times_Square_by_David_Shankbone.jpg/1280px-Lehman_Brothers_Times_Square_by_David_Shankbone.jpg)
...
![The Times front page from January 3, 2009 — the headline Satoshi embedded in Bitcoin's genesis block](https://upload.wikimedia.org/wikipedia/en/0/06/The_Times_Front_Page_3_January_2009.jpg)
...
graph LR
    ...
    style U1 fill:#1e40af,stroke:#1e3a8a,color:#fff
    style U2 fill:#1e40af,stroke:#1e3a8a,color:#fff
    style D1 fill:#059669,stroke:#047857,color:#fff
    style D2 fill:#059669,stroke:#047857,color:#fff
```

![Centralized vs Decentralized vs Distributed networks](https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Centralised-decentralised-distributed.png/600px-Centralised-decentralised-distributed.png)
