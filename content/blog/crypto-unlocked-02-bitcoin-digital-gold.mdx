...
On May 22, 2010, a programmer named Laszlo Hanyecz paid 10,000 Bitcoin for two Papa John's pizzas. At the time, that seemed like a reasonable deal—those coins were basically worthless internet tokens. Today, those same 10,000 BTC are worth over **one billion dollars.** That's roughly $500 million per pizza.

Every year, the crypto community celebrates May 22nd as "Bitcoin Pizza Day"—part joke, part monument to how far this thing has come. But here's the thing most people miss about that story: **it proved Bitcoin actually worked as money.** Someone offered it, someone accepted it, value transferred from one person to another without a bank in sight.

In Part 1, we covered *why* crypto exists—the broken trust, the bailouts, the 2008 meltdown. Now let's get into the *how*. How does Bitcoin actually work? What are miners doing? Why does everyone keep talking about "the halving"? And why do some very serious people call it digital gold?

No computer science degree required. Just stay with me.
...
**You have a wallet.** Think of it as a lockbox with two keys. One key is public—it's basically your address, like an email address anyone can send Bitcoin to. The other key is private—it's the password that proves you own what's in the lockbox. **Never share your private key.** Ever. We'll drill into this in Part 3.
...
- **Transparent** — anyone can read it. Right now. Go to [mempool.space](https://mempool.space) and you can see every Bitcoin transaction happening in real-time
...
That dice-rolling competition? It's called **Proof of Work (PoW)**, and it's the most controversial aspect of Bitcoin.
...
Is there room for improvement? Absolutely. And other cryptocurrencies (like Ethereum, which we'll cover in Part 5) have found less energy-intensive alternatives. But for Bitcoin specifically, the energy expenditure *is* the security. That's a feature, not a bug.
...
Every four years (roughly every 210,000 blocks), something remarkable happens: **the reward miners get for each block is cut in half.** This is called "the halving," and it's one of the most elegant mechanisms in all of economics.
...
The next halving is expected around **April 2028**. Mark your calendar. Or don't—the crypto community will not let you forget about it.
...
- The M2 money supply (a measure of all dollars in existence) has roughly **tripled** since 2000
...
> **Perspective:** About 19.8 million Bitcoin have already been mined. With ~8 billion people on Earth, if everyone wanted some, there's only about 0.0025 BTC per person. And an estimated 3-4 million BTC are lost forever (forgotten passwords, dead owners, Satoshi's untouched stash). The actual available supply is even smaller than you think.
...
|---|---|---|
| **Scarce** | Yes (limited supply on Earth) | Yes (21M cap, mathematically enforced) |
| **Durable** | Yes (doesn't decay) | Yes (exists as long as the network runs) |
| **Divisible** | Somewhat (hard to split a gold bar) | Extremely (divisible to 8 decimal places—0.00000001 BTC is called a "satoshi") |
| **Portable** | Barely (try flying with $1M in gold) | Completely (send $1B across the world in minutes) |
| **Verifiable** | Hard (need an expert to detect fakes) | Trivial (the blockchain verifies everything) |
| **Seizure-resistant** | No (governments confiscate gold routinely) | Very (if you hold your own keys) |
...
This isn't just internet speculation. BlackRock—the largest asset manager in the world with over $10 trillion under management—launched a Bitcoin ETF in 2024. Nation-states are adding Bitcoin to their reserves. Companies like MicroStrategy hold tens of billions of dollars in BTC on their balance sheet.
...
- **2009:** Satoshi mines the first block. Bitcoin is worth $0.
...
- **2014:** Mt. Gox, the largest Bitcoin exchange at the time, gets hacked. 850,000 BTC stolen. Trust shattered. Price crashes. Many declare Bitcoin dead (for the first of about 400 times).
- **2017:** The ICO bubble. Bitcoin hits $20,000. Your Uber driver is talking about crypto. Then it crashes 84%.
- **2020-2021:** Institutional adoption begins. Tesla buys $1.5B in Bitcoin. El Salvador makes it legal tender. Bitcoin hits $69,000.
- **2024:** Bitcoin ETFs approved. The halving happens. Bitcoin crosses **$100,000** for the first time. The "internet money" is now a mainstream financial asset.
...
- **It's not fast for payments.** Bitcoin processes ~7 transactions per second. Visa does 65,000. Layer 2 solutions like the Lightning Network are improving this, but it's not there yet for buying your morning coffee.
...
- **It's not easy for beginners.** Lose your private key? Your Bitcoin is gone forever. No customer support. No "forgot password." We'll solve this in Part 3.
...
In **Part 3: Wallets & Self-Custody**, we'll cover how to actually hold your own crypto. Hot wallets vs. cold wallets, seed phrases, hardware devices, and the golden rule: **not your keys, not your coins.** This is the most important practical lesson in the entire series.

Don't skip it.

*This is Part 2 of the 20-part [Crypto Unlocked](/blog/series/crypto-unlocked) series. New chapters drop weekly.*
