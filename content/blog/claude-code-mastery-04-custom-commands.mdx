...
`mkdir -p .claude/commands` — Create directory

`.claude/commands/name.md` — Basic command

`.claude/commands/git/commit.md` — Namespaced (`/git:commit`)
...
`Allowed-tools` — e.g., `Bash(git *), Read, Write`

`Model` — Override model

**Argument placeholders**

`$ARGUMENTS` — Everything after command
