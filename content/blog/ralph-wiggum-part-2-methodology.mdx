...
| Aspect | Planning Mode | Building Mode |
|--------|--------------|---------------|
| Prompt file | `PROMPT_plan.md` | `PROMPT_build.md` |
| Goal | Analyze & plan | Implement & test |
| Makes commits? | ❌ No | ✅ Yes |
| Writes code? | ❌ No | ✅ Yes |
| Runs tests? | ❌ No | ✅ Yes |
| Updates plan? | ✅ Creates/overwrites | ✅ Marks tasks complete |
| Typical iterations | 1-5 | 20-100+ |
| Run when? | Once, or when refreshing plan | Continuously until done |
