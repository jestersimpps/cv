...
Here's the difference between developers who "tried Ralph and it was okay" and developers who are shipping entire features overnight: **methodology**.

Running `/ralph-loop` on a vague prompt is like giving a junior developer a task with no context and no success criteria. They'll work hard. They'll produce *something*. But it probably won't be what you wanted.

The Three-Phase Methodology fixes this. It's how the pros run multi-day autonomous projects that actually work.
...
**Spend at least 30 minutes** talking through requirements with Claude before writing any code. Seriously. This conversation is where you catch the "oh wait, what about..." moments that would otherwise derail your overnight build.
...
# Talk with Claude, create specs/*.md files

# Phase 2: Planning (read-only loop)
/ralph-loop "$(cat PROMPT_plan.md)" --max-iterations 5 --completion-promise "PLAN COMPLETE"
...
- [The Ralph Playbook](https://claytonfarr.github.io/ralph-playbook/) — Complete methodology guide
- [Geoffrey Huntley's Guide](https://github.com/ghuntley/how-to-ralph-wiggum) — Original technique
- [11 Tips for AI Coding](https://www.aihero.dev/tips-for-ai-coding-with-ralph-wiggum) — Community best practices
- [Official Plugin](https://github.com/anthropics/claude-code/tree/main/plugins/ralph-wiggum) — Source and docs

---

*Previous: [Part 1: Introduction and Fundamentals](/blog/ralph-wiggum-part-1-introduction)*
*Next: [Part 3: Ralph TUI Monitoring](/blog/ralph-wiggum-part-3-ralph-tui-monitoring)*
