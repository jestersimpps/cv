...
You've probably heard about "ultrathink" and "think harder." Here's what actually works.

### What Works: ultrathink

```
ultrathink about how to architect this authentication system
```

This is the **only** extended thinking trigger that still works as of late 2025. It allocates a 32K token thinking budget—Claude gets more "mental runway" to:

- Consider multiple approaches before committing
- Evaluate trade-offs more thoroughly
- Catch edge cases it might otherwise miss
- Produce more carefully reasoned output

### What Doesn't Work Anymore

Early in 2025, phrases like "think hard," "think harder," and "megathink" triggered different thinking levels. **Not anymore.** Decompilation of recent Claude Code versions shows these keywords are now ignored.

```
# These no longer do anything special
think harder about this
think step by step
megathink
```

Don't believe guides that claim otherwise—they're outdated.

![Skeleton waiting meme - me waiting for "think harder" to actually do something](/assets/blog/skeleton-waiting-think-harder.jpg)

### When to Use ultrathink

**Use it for:**
- New feature design and architecture decisions
- When you're stuck in a loop and need fresh perspective
- Security reviews and complex debugging
- Any problem you'd schedule a meeting to discuss with a human
...
**The rule:** If it's worth thinking deeply about, use ultrathink. For everything else, skip it—extended thinking just adds latency.
...
```bash
# Extended thinking (only ultrathink works)
"ultrathink about..."
