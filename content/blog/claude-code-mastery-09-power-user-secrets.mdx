...
> **January 2026 Update:** `/compact` is now instant (v2.0.64+) and auto-compact triggers at 75% capacity. Also try `/context` to check MCP server usage before compacting.
...
> **January 2026 Update:** This is now built into Plan Mode. When you accept a plan, Claude auto-clears context and loads the plan fresh. Opt out if you prefer keeping context.

For complex multi-session work, use explicit documentation:
