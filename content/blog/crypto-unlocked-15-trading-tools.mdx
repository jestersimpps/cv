...
graph LR
    ...
    style AGG fill:#7c3aed,stroke:#5b21b6,color:#fff
    style UNI fill:#1e40af,stroke:#1e3a8a,color:#fff
    style CURVE fill:#1e40af,stroke:#1e3a8a,color:#fff
    style SUSHI fill:#1e40af,stroke:#1e3a8a,color:#fff
    style BAL fill:#1e40af,stroke:#1e3a8a,color:#fff
    style BEST fill:#059669,stroke:#047857,color:#fff
```
