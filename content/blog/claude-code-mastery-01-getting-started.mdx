...
> **Advanced permissions:** For fine-grained control with allow/deny lists, automated hooks, and team-wide permission policies, see [Settings Configuration in Part 3](/blog/claude-code-mastery-03-project-configuration#settingsjson-permissions-and-automation).
...
`/clear` — Fresh start (saves tokens)

`/model` — Switch models

`/compact` — Compress context

`/init` — Update CLAUDE.md
