...
![Impermanent loss visualized — comparing a HODL strategy versus providing liquidity when prices diverge](/assets/blog/crypto-unlocked-10/impermanent-loss.png)
...
![Concentrated liquidity vs full-range — v3 lets you focus capital where trades actually happen instead of spreading it from zero to infinity](/assets/blog/crypto-unlocked-10/concentrated-liquidity.png)
